...
export function WhatsAppButton() {
  ...
  return (
    <a href={`https://wa.me/${num}`} target="_blank" rel="noopener noreferrer"
      ...
      className="fixed z-40 right-4 bottom-20 lg:bottom-6 w-12 h-12 rounded-full bg-[#25D366] text-white shadow-lg flex items-center justify-center hover:scale-105 transition">
